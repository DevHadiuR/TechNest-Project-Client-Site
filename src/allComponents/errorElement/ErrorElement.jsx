...
const ErrorElement = () => {
  return (
    <div className="min-w-screen min-h-screen bg-[#4F1787] flex items-center p-5 lg:p-20 overflow-hidden relative">
      <div className="flex-1 min-h-full min-w-full rounded-3xl bg-[#EB3678] shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
        <div className="w-full md:w-1/2">
          <div className="mb-10 lg:mb-20">
            ...
            >
              <p className="text-3xl flex justify-between items-center">
                ...
                <span className="font-signature text-xl md:text-6xl">
                  {" "}
                  Tech
          ...
          <div className="mb-10 md:mb-20 text-gray-600 font-light">
            <h1 className="font-black uppercase text-3xl lg:text-5xl text-[#180161] mb-10">
              You seem to be lost!
            </h1>
          ...
          <div className="mb-20 md:mb-0">
            <Link to="/">
              <Button
                size="sm"
                color="red"
                className="text-lg font-medium outline-none focus:outline-none transform transition-all hover:scale-110"
              >
                Go Back
              </Button>
            </Link>
